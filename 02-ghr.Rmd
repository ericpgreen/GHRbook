...
**Applied research** focuses on specific problems or real-world applications. Whereas the basic scientist might toil away in the lab to understand how cellular enzymes function without a specific clinical application in mind, the applied researcher will take this knowledge of enzymes to develop new therapies that could treat cancer.
...
v3=c(
  "Are there signs that the drug candidate will have an effect?",
...
This can all get a bit confusing, so here is a brief summary. 
...
v2=c(
  ...
  "Lab (in vitro) or animal (in vivo) research to prepare for clinical research with human subjects",
...
v3=c(
  ...
  "What happens to this enzyme when a particular compound is introduced in the lab?",
...
```{marginfigure}
Evaluation is a big tent. Some program evaluations aim to (or can claim to) measure impact. Many do not.
```
