...
Maybe I would have made the cut had had I said, "**global health is the study and practice of improving health and achieving equity in health for all people worldwide**. This is how @koplan:2009 defined global health in a *Lancet* article published later the same year. The also offered this longer version:
...
```{r pancakes, fig.cap="Source: [http://tinyurl.com/yxtabza3](http://tinyurl.com/yxtabza3)", echo=F, fig.margin = TRUE}
...
In later chapters we will learn strategies for writing a good Method section (and appendices!) and discuss why replications are actually rare in practice—and why they can be so controversial.
...
Now take a look at Afghanistan on the right. Note that the y-axis scale is much larger in the 1000s, reflecting the fact that many more Afghan women die of causes related to pregnancy or childbirth. Next, pay attention to the width of the uncertainty band. It spans more than a 3000 death range compared to a range of fewer than 5 deaths in the US! This is because there are very few data points available to estimate the "true" value, and these data points can differ by more than 1000 deaths. We don't know much about maternal mortality in Afghanistan, but the blue line is our best guess.
...
```{r rtss, fig.cap="RTS,S timeline. Source: [http://www.sciencedirect.com/science/article/pii/S0264410X15013377](http://www.sciencedirect.com/science/article/pii/S0264410X15013377).", echo=F, fig.fullwidth = FALSE}
