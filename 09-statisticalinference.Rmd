...
But is that the best take? Not everyone thought so. Here's what [Dr. Ken Rothman](https://www.bu.edu/sph/profile/kenneth-rothman/) and his colleagues wrote to the journal editors:
...
**The null is where statistical inference happens.** The Frequentist rejects or retains the null hypothesis, but does not direcltly prove the alternative. They simply decide whether there is sufficient evidence to convict (i.e., reject) the null.
...
Bottomline: Frequentist confidence intervals are an improvement over *p*-values, but they still do not tell you the probability that your hypothesis is correct. For that we need the Bayesian approach.
...
```{marginfigure}
Bayesians do not conduct significance testing. The closest thing is something called a Bayes factor. I think Bayes factors take us back down the road of NHST-style dichotomous thinking, so I'll leave it for you to explore on your own.
```
